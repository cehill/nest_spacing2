...
## Here's where the code creates a new file, data5, from data3 and by calling the functions nn.dist and num.1500 defined just above. This bit pastes the newly calculated nearest neighbor nest data with the original data that's still in "data3", using an intermediate file called "n.data" and eventually creating "data5," which has the neighbor data for each nest.
